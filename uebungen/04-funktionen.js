...
console.log('-----------------------------------------------')
//Der Vorteil von Funktionen ist, dass die Berechnung im Rumpf nur einnmal ausformuliert werden muss.
...
//   Funktionen können mehrere oder auch keinen Parameter entgegennehmen. 
...
console.log('Berechne das Volumen eines Quarders mit einer Funktion')

function berechneVolumen(laenge, breite, hoehe){
    return laenge * breite * hoehe 
}

console.log('Volumen: ' + berechneVolumen(5,5,5))
console.log('----------------------------------')
console.log('AUFGABE 2')
console.log('Berechne den Bruttopreis aus dem Nettopreis:')
...
console.log('Berechne die Schulnote aus der Abiturpunktzahl')
